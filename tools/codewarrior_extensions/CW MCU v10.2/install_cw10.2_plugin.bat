...
if exist "%~1/MCU/lib/wizard_data/mqx/4.0" (
    echo **** Uninstalling old plug-ins for MQX 4.0 ****
    "%~1/eclipse/cwidec.exe" -nosplash -application org.eclipse.equinox.p2.director -repository file:"%CD%/mqx_p2_repository/" -uninstallIU com.freescale.mqx.v4.0.feature.group > NUL 2>&1
)
echo **** Installing plug-ins for MQX 4.0 ****
"%~1/eclipse/cwidec.exe" -nosplash -application org.eclipse.equinox.p2.director -repository file:"%CD%/mqx_p2_repository/" -installIU com.freescale.mqx.v4.0.feature.group
