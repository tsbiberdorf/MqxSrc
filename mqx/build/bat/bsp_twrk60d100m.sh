...
cp -f "${MQXROOTDIR}/config/twrk60d100m/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/bsp.h" "${OUTPUTDIR}/bsp.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/twrk60d100m.h" "${OUTPUTDIR}/twrk60d100m.h"
...
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/cw/dbg/init_kinetis.tcl" "${OUTPUTDIR}/../../dbg/init_kinetis.tcl"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/cw/dbg/mass_erase_kinetis.tcl" "${OUTPUTDIR}/../../dbg/mass_erase_kinetis.tcl"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/cw/dbg/twrk60d100m.mem" "${OUTPUTDIR}/../../dbg/twrk60d100m.mem"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/cw/intflash.lcf" "${OUTPUTDIR}/intflash.lcf"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/cw/intram.lcf" "${OUTPUTDIR}/intram.lcf"
fi
# iar files
if [ "${TOOL}" = "iar" ]; then
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
fi
# cw10gcc files
if [ "${TOOL}" = "cw10gcc" ]; then
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/gcc_cw/intflash.ld" "${OUTPUTDIR}/intflash.ld"
fi
# uv4 files
if [ "${TOOL}" = "uv4" ]; then
cp -f "${MQXROOTDIR}/mqx/source/bsp/twrk60d100m/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
fi
