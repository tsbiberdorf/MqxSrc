...
copy %MQXROOTDIR%\config\twrk60d100m\user_config.h %OUTPUTDIR%\..\user_config.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\bsp.h %OUTPUTDIR%\bsp.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\bsp_cm.h %OUTPUTDIR%\bsp_cm.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\bsp_rev.h %OUTPUTDIR%\bsp_rev.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\init_lpm.h %OUTPUTDIR%\init_lpm.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\PE_LDD.h %OUTPUTDIR%\Generated_Code\PE_LDD.h /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\twrk60d100m.h %OUTPUTDIR%\twrk60d100m.h /Y
...
IF NOT EXIST %OUTPUTDIR%\Generated_Code mkdir %OUTPUTDIR%\Generated_Code
for /R %MQXROOTDIR%\mqx\build\cw10\bsp_twrk60d100m\Generated_Code %%f in (*.h) do copy %%f %OUTPUTDIR%\Generated_Code\
IF NOT EXIST %OUTPUTDIR%\Sources mkdir %OUTPUTDIR%\Sources
for /R %MQXROOTDIR%\mqx\build\cw10\bsp_twrk60d100m\Sources %%f in (*.h) do copy %%f %OUTPUTDIR%\Sources\
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\cw\dbg\init_kinetis.tcl %OUTPUTDIR%\..\..\dbg\init_kinetis.tcl /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\cw\dbg\mass_erase_kinetis.tcl %OUTPUTDIR%\..\..\dbg\mass_erase_kinetis.tcl /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\cw\dbg\twrk60d100m.mem %OUTPUTDIR%\..\..\dbg\twrk60d100m.mem /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\cw\intflash.lcf %OUTPUTDIR%\intflash.lcf /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\cw\intram.lcf %OUTPUTDIR%\intram.lcf /Y
goto copy_end

rem iar files
:tool_iar
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\iar\intflash.icf %OUTPUTDIR%\intflash.icf /Y
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\iar\ram.icf %OUTPUTDIR%\ram.icf /Y
goto copy_end

rem cw10gcc files
:tool_cw10gcc
IF NOT EXIST %OUTPUTDIR%\Generated_Code mkdir %OUTPUTDIR%\Generated_Code
for /R %MQXROOTDIR%\mqx\build\cw10gcc\bsp_twrk60d100m\Generated_Code %%f in (*.h) do copy %%f %OUTPUTDIR%\Generated_Code\
IF NOT EXIST %OUTPUTDIR%\Sources mkdir %OUTPUTDIR%\Sources
for /R %MQXROOTDIR%\mqx\build\cw10gcc\bsp_twrk60d100m\Sources %%f in (*.h) do copy %%f %OUTPUTDIR%\Sources\
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\gcc_cw\intflash.ld %OUTPUTDIR%\intflash.ld /Y
goto copy_end

rem uv4 files
:tool_uv4
copy %MQXROOTDIR%\mqx\source\bsp\twrk60d100m\uv4\intflash.scf %OUTPUTDIR%\intflash.scf /Y
goto copy_end
