...
#
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&((task)|(stack\\w*)).o"           => "TASK_ROM",
    ".(data|bss)&psp.a&((task)|(stack\\w*)).o"                   => "TASK_RAM",
...
(
    ...
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(httpd|httpd_mqx|httpd_supp|httpd_task).o"           => "RTCS_HTTPD_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(httpd|httpd_mqx|httpd_supp|httpd_task).o" => "RTCS_HTTPD_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(httpd|httpd_mqx|httpd_supp|httpd_task).o"           => "RTCS_HTTPD_RAM",
    
    # FTP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(ftpclnt|ftpd_cmd|ftpd_msg).o" => "RTCS_FTP_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(ftpclnt|ftpd_cmd|ftpd_msg).o"           => "RTCS_FTP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(ftpclnt|ftpd_cmd|ftpd_msg).o" => "RTCS_FTP_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(ftpclnt|ftpd_cmd|ftpd_msg).o"           => "RTCS_FTP_RAM",
    ...
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|select|inet_ntop|inet_pton|rtcs\\w*).o"           => "RTCS_RTCS4_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|select|inet_ntop|inet_pton|rtcs\\w*).o" => "RTCS_RTCS4_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|select|inet_ntop|inet_pton|rtcs\\w*).o"           => "RTCS_RTCS4_RAM",
    
    #RTCSv6
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(ifadd6|ifrem6|rtcscmd6).o" => "RTCS_RTCS6_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(ifadd6|ifrem6|rtcscmd6).o"           => "RTCS_RTCS6_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(ifadd6|ifrem6|rtcscmd6).o" => "RTCS_RTCS6_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(ifadd6|ifrem6|rtcscmd6).o"           => "RTCS_RTCS6_RAM",
