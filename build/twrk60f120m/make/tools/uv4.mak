...
INCLUDE += $(TOOLCHAIN_ROOTDIR)/ARM/INC/Freescale/K60
...
ifeq ($(CONFIG),debug)
ifeq ($(NAME),psp)
CC_FLAGS += -O0 --cpu Cortex-M4.fp --library_interface=armcc --library_type=standardlib --apcs=interwork --split_sections --li --c99 -g 
CX_FLAGS += --cpu Cortex-M4.fp --library_interface=armcc --library_type=standardlib --apcs=interwork --split_sections --li --cpp -g 
AS_FLAGS += --cpu Cortex-M4.fp --apcs=interwork --cpreproc --xref --li -g 
AR_FLAGS += 
LD_FLAGS += --cpu Cortex-M4.fp --remove --keep linker_symbols.o\(KERNEL_DATA_START\) --keep linker_symbols.o\(KERNEL_DATA_END\) --keep linker_symbols.o\(BOOT_STACK\) --keep vectors.o\(.vectors_rom\) --autoat --xref --summary_stderr --info summarysizes --map --callgraph --symbols --info sizes --info totals --info unused --info veneers --strict --diag_suppress=L6314W 
...
ifeq ($(CONFIG),release)
ifeq ($(NAME),psp)
CC_FLAGS += -O3 --cpu Cortex-M4.fp --library_interface=armcc --library_type=standardlib --apcs=interwork --split_sections --li --c99 -g 
CX_FLAGS += --cpu Cortex-M4.fp --library_interface=armcc --library_type=standardlib --apcs=interwork --split_sections --li --cpp -g 
AS_FLAGS += --cpu Cortex-M4.fp --apcs=interwork --cpreproc --xref --li -g 
AR_FLAGS += 
LD_FLAGS += --cpu Cortex-M4.fp --remove --keep linker_symbols.o\(KERNEL_DATA_START\) --keep linker_symbols.o\(KERNEL_DATA_END\) --keep linker_symbols.o\(BOOT_STACK\) --keep vectors.o\(.vectors_rom\) --autoat --xref --summary_stderr --info summarysizes --map --callgraph --symbols --info sizes --info totals --info unused --info veneers --strict --diag_suppress=L6314W 
