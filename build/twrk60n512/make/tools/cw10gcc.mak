...
ifeq ($(CONFIG),debug)
ifeq ($(NAME),psp)
CC_FLAGS += -O0 -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -nostdinc -ffunction-sections -fdata-sections -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf 
CX_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -nostdinc -nostdinc++ -ffunction-sections -fdata-sections -fno-exceptions -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf 
AS_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf 
AR_FLAGS += 
...
ifeq ($(CONFIG),release)
ifeq ($(NAME),psp)
CC_FLAGS += -Os -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -nostdinc -ffunction-sections -fdata-sections -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf 
CX_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -nostdinc -nostdinc++ -ffunction-sections -fdata-sections -fno-exceptions -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf 
AS_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf 
AR_FLAGS += 
LD_FLAGS += -mcpu=cortex-m4 -mfloat-abi=soft -std=gnu99 -nostartfiles -nodefaultlibs -nostdlib -Xlinker --gc-sections -Xlinker -cref -Xlinker -static -mthumb -g2 -gdwarf-2 -gstrict-dwarf -Xlinker -z -Xlinker muldefs 
