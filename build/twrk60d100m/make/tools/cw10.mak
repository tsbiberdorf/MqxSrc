...
ifeq ($(CONFIG),debug)
ifeq ($(NAME),psp)
CC_FLAGS += -opt level=0 -proc cortex-m4 -fp soft -little -msgstyle parseable -g3 -thumb -interworking -lavender model=ewl ,print=int ,scan=int ,io=raw -cwd include -nosyspath -nolink -enc ascii -w illpragmas -w possible -w missingreturn -w extracomma -w empty -inline on -generic_symbol_names off -sdata 8 -enum int -char signed -Cpp_Exceptions off -RTTI off -opt space -lang c99 
CX_FLAGS += -proc cortex-m4 -fp soft -little -msgstyle parseable -g3 -thumb -interworking -lavender model=ewl ,print=int ,scan=int ,io=raw -cwd include -nosyspath -nolink -enc ascii -w illpragmas -w possible -w missingreturn -w extracomma -w empty -inline on -generic_symbol_names off -sdata 8 -enum int -char signed -opt space -lang c++ 
AS_FLAGS += -proc cortex-m4 -little -msgstyle parseable -g -nosyspath 
AR_FLAGS += -proc cortex-m4 -sreclength 80 -srec -map -library -nostdlib -interworking -thumb -g3 -msgstyle parseable -little 
LD_FLAGS += -proc cortex-m4 -msgstyle parseable -g3 -thumb -interworking -lavender model=ewl ,print=int ,scan=int ,io=raw -nostdlib -main __boot -map -map closure -map keep -srec -sreclength 80 -little 
...
ifeq ($(CONFIG),release)
ifeq ($(NAME),psp)
CC_FLAGS += -opt level=4 -proc cortex-m4 -fp soft -little -msgstyle parseable -g3 -thumb -interworking -lavender model=ewl ,print=int ,scan=int ,io=raw -cwd include -nosyspath -nolink -enc ascii -w illpragmas -w possible -w missingreturn -w extracomma -w empty -inline on -generic_symbol_names off -sdata 8 -enum int -char signed -Cpp_Exceptions off -RTTI off -opt space -lang c99 
CX_FLAGS += -proc cortex-m4 -fp soft -little -msgstyle parseable -g3 -thumb -interworking -lavender model=ewl ,print=int ,scan=int ,io=raw -cwd include -nosyspath -nolink -enc ascii -w illpragmas -w possible -w missingreturn -w extracomma -w empty -inline on -generic_symbol_names off -sdata 8 -enum int -char signed -opt space -lang c++ 
AS_FLAGS += -proc cortex-m4 -little -msgstyle parseable -g -nosyspath 
AR_FLAGS += -proc cortex-m4 -sreclength 80 -srec -map -library -nostdlib -interworking -thumb -g3 -msgstyle parseable -little 
LD_FLAGS += -proc cortex-m4 -msgstyle parseable -g3 -thumb -interworking -lavender model=ewl ,print=int ,scan=int ,io=raw -nostdlib -main __boot -map -map closure -map keep -srec -sreclength 80 -little 
