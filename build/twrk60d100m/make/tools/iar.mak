...
ifeq ($(CONFIG),debug)
ifeq ($(NAME),psp)
CC_FLAGS += -On --cpu=Cortex-M4 --fpu=None --diag_suppress Pa039,Pe068,Pe069,Pa082,Pe177,Pe186,Pe550 --no_cse --no_unroll --no_inline --no_code_motion --no_tbaa --no_clustering --no_scheduling --debug --endian=little -e --use_c++_inline --silent 
CX_FLAGS += -On --cpu=Cortex-M4 --fpu=None --diag_suppress Pa039,Pe068,Pe069,Pa082,Pe177,Pe186,Pe550 --no_cse --no_unroll --no_code_motion --no_tbaa --no_clustering --no_scheduling --debug --endian=little -e --ec++ 
AS_FLAGS += --cpu Cortex-M4 --fpu None -s -M'<>' -w+ -r -j -S 
AR_FLAGS += 
...
ifeq ($(CONFIG),release)
ifeq ($(NAME),psp)
CC_FLAGS += -Oh --cpu=Cortex-M4 --fpu=None --diag_suppress Pa039,Pe068,Pe069,Pa082,Pe177,Pe186,Pe550 --no_cse --no_unroll --no_inline --no_code_motion --no_tbaa --no_clustering --no_scheduling --debug --endian=little -e --use_c++_inline --silent 
CX_FLAGS += -Oh --cpu=Cortex-M4 --fpu=None --diag_suppress Pa039,Pe068,Pe069,Pa082,Pe177,Pe186,Pe550 --no_cse --no_unroll --no_code_motion --no_tbaa --no_clustering --no_scheduling --debug --endian=little -e --ec++ 
AS_FLAGS += --cpu Cortex-M4 --fpu None -s -M'<>' -w+ -r -j -S 
AR_FLAGS += 
LD_FLAGS += --entry __iar_program_start 
